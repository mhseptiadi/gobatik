...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'script_url' => UPLIBHTTP,
            'upload_dir' => UPLIBSITE,
            'upload_url' => UPLIBURL,
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        ...
        if (empty($version)) {
            ...
            $version_dir = isset($this->options['image_versions'][$version]['upload_dir'])?$this->options['image_versions'][$version]['upload_dir']:'';
            if ($version_dir) {
    ...
    protected function get_file_date($file_path) {
        ...
        return date("D, d M Y, H:i:s",filemtime($file_path));
    }
