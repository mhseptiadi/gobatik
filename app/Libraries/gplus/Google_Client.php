...
$root = APP.'Libraries/gplus/';

// Include the top level classes, they each include their own dependencies
require_once $root.'service/Google_Model.php';
require_once $root.'service/Google_Service.php';
require_once $root.'service/Google_ServiceResource.php';
require_once $root.'auth/Google_AssertionCredentials.php';
require_once $root.'auth/Google_Signer.php';
require_once $root.'auth/Google_P12Signer.php';
require_once $root.'service/Google_BatchRequest.php';
require_once $root.'external/URITemplateParser.php';
require_once $root.'auth/Google_Auth.php';
require_once $root.'cache/Google_Cache.php';
require_once $root.'io/Google_IO.php';
require_once($root.'service/Google_MediaFileUpload.php');
