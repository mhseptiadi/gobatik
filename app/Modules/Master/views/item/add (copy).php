...
<?php $this->output('template/sidebar');?>
  	...
  	<div class="mainbar">
        ...
        <div class="bread-crumb pull-right">
          <a href="<?=MASTERHTTP?>"><i class="fa fa-home"></i> Home</a> 
          <!-- Divider -->
          <span class="divider">/</span> 
          <a href="<?=MASTERHTTP?>item/add" class="bread-current">Add Item</a>
        </div>
...
-->
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <br />
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" action="<?=MASTERHTTP?>item/add" method="post">
                                <div class="form-group">
                                  <label class="col-lg-2 control-label">Item Name</label>
                                  <div class="col-lg-5">
                                    <input name="name" type="text" class="form-control" placeholder="Input Box" required>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <input name="buy" type="number" min="0" step="1" class="form-control" placeholder="Input Box" required>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <input name="sell" type="number" min="0" step="1" class="form-control" placeholder="Input Box" required>
                                  </div>
                                </div>
								...
								<div class="form-group">
                                  ...
                                  <div class="col-lg-5">
									<img style="display:none;max-height:100%; max-width:100%;cursor:pointer;" onclick="imgPop(this.src)" src="" id="coverImg" />
									<div class="input-group">
										<input name="cover" id="cover" type="text" class="form-control" placeholder="cover">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-6">
                                    <textarea name="description" class="cleditor" name="input"></textarea>
                                  </div>
                                </div>   
                                <div class="form-group">
                                  <label class="col-lg-2 control-label">Note</label>
                                  <div class="col-lg-5">
                                    <textarea name="note" class="form-control" rows="5" placeholder="Textarea"></textarea>
                                  </div>
                                </div>  
                                <div class="form-group">
                                  <label class="col-lg-2 control-label">Stock</label>
                                  <div class="col-lg-5">
                                    <input name="stock" type="number" min="0" step="1" class="form-control" placeholder="Input Box" required>
                                  </div>
                                </div>       
