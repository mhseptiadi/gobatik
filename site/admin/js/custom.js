...
$(document).ready(function(){
  ...
  setTimeout(function() {noty({text: '<strong>Edit me on admin/js/custom.js</strong>',layout:'top',type:'information',timeout:1000});}, 1000);

  //~ setTimeout(function() {noty({text: 'Edit me on admin/js/custom.js',layout:'topRight',type:'alert',timeout:6000});}, 3000);
